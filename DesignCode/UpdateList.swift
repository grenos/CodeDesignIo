...
struct UpdateList: View {
	...
	func addUpdate() {
		store.updates.append(Update(image: "Card1", title: "New ITem", text: "text", date: "123"))
	}
	...
	var body: some View {
		...
		NavigationView {
			...
			.navigationBarItems(leading: Button(action: addUpdate) {Text("Add Update")}, trailing: EditButton())
		}
	}
}
